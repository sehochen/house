...
<form action="/house/index.php/House/add" enctype="multipart/form-data" method="post">
	...
	<div class="mui-row" style="background-color:white;margin-top:1%;">
		...
		<ul class="mui-table-view">
		    ...
		    <li class="mui-table-view-cell upload_img">
				<img src="/house/Public/Home/images/add_img.png" alt="添加图片" id="1" name="img[]">
				<img src="/house/Public/Home/images/add_img.png" alt="添加图片" id="2" name="img[]">	
				<img src="/house/Public/Home/images/add_img.png" alt="添加图片" id="3" name="img[]">
				<img src="/house/Public/Home/images/add_img.png" alt="添加图片" id="4" name="img[]">
		    </li> 
		    ...
		    <li class="mui-table-view-cell">
		    	<div class="mui-input-row">
			    	...
			    	<select name="pay_ren" id="">
			    		<option value="付三押一">付三押一</option>
			    		<option value="付二押一">付二押一</option>
			    		<option value="付一押一">付一押一</option>
		...
		<ul class="mui-table-view">
		    ...
		    <li class="mui-table-view-cell">
				<form class="mui-input-group">
					...
					<div class="mui-input-row mui-checkbox mui-left">
						<label>洗衣机</label>
						<input name="facilities[]" value="洗衣机" type="checkbox">
					</div>
					<div class="mui-input-row mui-checkbox mui-left">
						<label>宽带</label>
						<input name="facilities[]" value="宽带" type="checkbox">
					</div>
					<div class="mui-input-row mui-checkbox mui-left">
						<label>电视机</label>
					...
					<div class="mui-input-row mui-checkbox mui-left">
						<label>厨房</label>
						<input name="facilities[]" value="厨房" type="checkbox">
					</div>
					<div class="mui-input-row mui-checkbox mui-left">
						<label>热水器</label>
		...
		<ul class="mui-table-view">
		    ...
		    <li class="mui-table-view-cell">
				<form class="mui-input-group">
					...
					<div class="mui-input-row mui-checkbox mui-left">
						<label>女生</label>
						<input name="demand[]" value="女生" type="checkbox">
					</div>
					<div class="mui-input-row mui-checkbox mui-left">
						<label>不喝酒</label>
						<input name="demand[]" value="不喝酒" type="checkbox">
					</div>
					<div class="mui-input-row mui-checkbox mui-left">
						<label>不吸烟</label>
					...
					<div class="mui-input-row mui-checkbox mui-left">
						<label>爱干净</label>
						<input name="demand[]" value="爱干净" type="checkbox">
					</div>
					<div class="mui-input-row mui-checkbox mui-left">
						<label>作息规律</label>
