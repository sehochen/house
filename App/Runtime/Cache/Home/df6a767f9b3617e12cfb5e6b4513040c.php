	...
	<div class="mui-row">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="mui-table-view-cell mui-media">
					<a href="javascript:;" class="bool_list">
						<!-- <img class=" mui-pull-left" src="/house/Public/<?php echo ($vo["head"]); ?>" height="50px" width="50px"> -->
					...
					<div style="margin-top:0.2em;">  
						<span style="float:right;"> 
							[ <a href="javascript:;" onclick="cancel('/house/index.php/Message/cancel/id/<?php echo ($vo["id"]); ?>')">删除消息</a> ] 
						</span> <br>
						
						发送时间 <?php echo date('Y-m-d H:i:s',$vo['add_time']);?>						
					</div>
				...
				$.post(url, {},
				    function(data){
				      ...
				      if( data.status==0 ){
				      	...
				      	mui.toast(data.message);
				      	setTimeout(function(){
				      		window.location="/house/index.php/Message";
				      	},2000);
				      }
