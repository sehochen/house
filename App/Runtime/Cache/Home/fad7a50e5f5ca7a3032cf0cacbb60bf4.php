...
<form action="/house/index.php/Appointment/add/hid/8" method="post" id="form">	
...
<input type="hidden" name="hid" value="<?php echo I('get.hid');?>">
	...
	<center>
		<input type="button" value=" 确 定 预 约 " style="margin:0.5em 0;" onclick="submit('/house/index.php/Appointment/add/hid/8')">
	</center>
